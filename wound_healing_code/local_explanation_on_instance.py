...
parser.add_argument('--AB_img_path',type=str,default='/data/Skin_MT/testAB/') ###all test images (including A and B) are placed in this folder
parser.add_argument('--CAE_trained_gen_model_path',type=str,default='/trained_models/CAE_gen_skin_trained_model.pt')
parser.add_argument('--outer_classifier_path',type=str,default='/trained_models/blackbox_classifier(res50)_skin_trained_model.pth') #### black-box model whose behaviors on local instance will be explained
...
explained_case_name='A.png'
counter_reference_case_name='B.png'

# distances between wound-related feature sampled and the wound-related feature of the explained example along with the guided path formed by the wound-related features of the example and the reference counter example
...
c_A, s_A = encode(example_img)   ### s_A is the wound-related feature of the example_img
c_B, s_B=encode(counter_example_img) ### s_B is the wound-related feature of the counter_example_img
