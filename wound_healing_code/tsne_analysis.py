...
parser.add_argument('--latentAB_save_path',type=str,default='/results/testAB_WR_features_extraction_results.csv')  ###where the class-associated codes extracted from the images and the images label are recorded
