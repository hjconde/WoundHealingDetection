...
parser.add_argument('--trainA_img_path',type=str,default='/data/Skin_MT/trainA/')  ###training images with class A (Control group, without wound) are placed into this folder
parser.add_argument('--trainB_img_path',type=str,default='/data/Skin_MT/trainB/')  ###training images with class B (Experimental group, with wound) are placed into this folder
parser.add_argument('--testA_img_path',type=str,default='/data/Skin_MT/testA/') ###testing images with class A are placed into this folder
parser.add_argument('--testB_img_path',type=str,default='/data/Skin_MT/testB/') ###testing images with class B are placed into this folder
parser.add_argument('--train_label_file',type=str,default='/data/Skin_MT/trainAB_img-name_label.txt')  #### name and label of each training image are presented in each line in this file, like the first line:"skin_image_name1 1", where 1 refers to the label.
parser.add_argument('--test_label_file',type=str,default='/data/Skin_MT/testAB_img-name_label.txt')
parser.add_argument('--style_dim',type=int,default=8) ### the dimension setting of the wound-related features
